...
Initially we recommend that you [search](https://github.com/subversivo58/emoji-extractor/issues) for similar issues that may have already been resolved, case no, open new [issue](https://github.com/subversivo58/emoji-extractor/issues/new).
